...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  probePlaylist: (url) => ipcRenderer.invoke('probe-playlist', url),
  ...
  onYtDlpChannelChanged: (callback) => ipcRenderer.on('yt-dlp-channel-changed', (_event, value) => callback(value)),
  ...
  onDependencyUpdateStatus: (callback) => ipcRenderer.on('dependency-update-status', (_event, value) => callback(value)),
